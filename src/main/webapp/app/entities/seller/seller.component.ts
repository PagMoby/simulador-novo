...
export class SellerComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.sellerService
      ...
      .subscribe(
        (res: HttpResponse<ISeller[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: ISeller[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
