...
/**
 * REST controller for managing {@link br.com.pagmoby.simulador.domain.Plano}.
 */
@RestController
@RequestMapping("/api")
public class PlanoResource {
     ...
     */
    @PostMapping("/planos")
    public ResponseEntity<PlanoDTO> createPlano(@RequestBody PlanoDTO planoDTO) throws URISyntaxException {
     ...
     */
    @PutMapping("/planos")
    public ResponseEntity<PlanoDTO> updatePlano(@RequestBody PlanoDTO planoDTO) throws URISyntaxException {
