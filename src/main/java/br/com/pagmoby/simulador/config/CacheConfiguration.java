...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, br.com.pagmoby.simulador.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, br.com.pagmoby.simulador.repository.UserRepository.USERS_BY_EMAIL_CACHE);
