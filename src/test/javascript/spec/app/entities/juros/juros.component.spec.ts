...
import { JurosComponent } from 'app/entities/juros/juros.component';
import { JurosService } from 'app/entities/juros/juros.service';
import { Juros } from 'app/shared/model/juros.model';

describe('Component Tests', () => {
  describe('Juros Management Component', () => {
    let comp: JurosComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(JurosComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.juros && comp.juros[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
